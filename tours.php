...
$result = $conn->query("SELECT * FROM treks WHERE product_type = 'tour' ORDER BY id ASC");
$count = $result->num_rows;
?>
<?php include 'includes/header.php'; ?>

<div class="page-header">
    <span class="breadcrumb">ALL EXPERIENCES</span>
    <h1>OUR <span class="accent">TOURS</span></h1>
    <p><?= $count ?> tour experiences available &middot; Fully customisable</p>
</div>

<div class="filters-bar">
    <div class="search-box">
        <span>&#128269;</span>
        <input type="text" id="trekSearch" placeholder="Search tours...">
    </div>
