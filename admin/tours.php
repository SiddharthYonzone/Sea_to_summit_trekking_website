...
$treks = $conn->query("SELECT * FROM treks WHERE product_type = 'tour' ORDER BY id DESC");
?>
...
<div class="admin-page-header">
    <div>
        <h1>TOURS</h1>
        <p>Add, edit, or remove tour packages (cultural tours, jungle safaris, city experiences, etc). Changes go live immediately.</p>
    </div>
    <a href="trek-form.php?type=tour" class="btn btn-primary">+ ADD NEW TOUR</a>
</div>

<?php if (isset($_GET['deleted'])): ?>
    <div class="alert alert-success">Tour deleted.</div>
<?php elseif (isset($_GET['saved'])): ?>
    <div class="alert alert-success">Tour saved successfully.</div>
<?php endif; ?>
